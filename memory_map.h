...
// for delayed buffers
#define DELAY_BUF_MAP_ADDR					(TEMPORARY_DATA_BUFFER_MAP_ADDR + sizeof(TEMPORARY_DATA_BUF_MAP))
#define DELAY_BUF_HASH_TABLE_ADDR			(DELAY_BUF_MAP_ADDR + sizeof(DELAY_BUF_MAP))
#define DSM_RANGE_ADDR						(DELAY_BUF_HASH_TABLE_ADDR + sizeof(DELAY_BUF_HASH_TABLE))


// for map tables
//#define LOGICAL_SLICE_MAP_ADDR				(TEMPORARY_DATA_BUFFER_MAP_ADDR + sizeof(TEMPORARY_DATA_BUF_MAP))
#define LOGICAL_SLICE_MAP_ADDR				(DSM_RANGE_ADDR + sizeof(DSM_RANGE))
...
#define RESERVED1_END_ADDR					0x7FFFFFFF
